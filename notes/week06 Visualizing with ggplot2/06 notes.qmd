...
```
![](C:/Users/Macarena/MacarenaLM/notes/week06 Visualizing with ggplot2/ggplot2 box plot 14.png){width=50%}
...
```
![](C:/Users/Macarena/MacarenaLM/notes/week06 Visualizing with ggplot2/ggplot2 box plot 16.png){width=50%}

(in this case, background is white and there is no lines from axis)
...
```
![](C:/Users/Macarena/MacarenaLM/notes/week06 Visualizing with ggplot2/ggplot2 box plot 17.png){width=50%}

(here, the background is white and appears lines from axis. Also there is an square surrounding the plot)
...
```
![](C:/Users/Macarena/MacarenaLM/notes/week06 Visualizing with ggplot2/ggplot2 box plot 18.png){width=50%}

(brackground in white, no axis or square)
...
```
![](C:/Users/Macarena/MacarenaLM/notes/week06 Visualizing with ggplot2/ggplot2 box plot 19.png){width=50%}
...
```
![](C:/Users/Macarena/MacarenaLM/notes/week06 Visualizing with ggplot2/ggplot2 box plot 20.png){width=50%}
...
```
![](C:/Users/Macarena/MacarenaLM/notes/week06 Visualizing with ggplot2/ggplot2 box plot 21.png){width=50%}
...
```
![](C:/Users/Macarena/MacarenaLM/notes/week06 Visualizing with ggplot2/ggplot2 box plot 22.png){width=50%}
...
titled "The cytoframe and cytoset classes" in the package vignette:
  ...
  We are going to use again the example from week5 to obtain a GatingSet object:
...
```
And we are going to use some ggplot2 functions:

```{r}
Plot + theme_bw()
```
![](C:/Users/Macarena/MacarenaLM/notes/week06 Visualizing with ggplot2/ggplot2 3.png){width=50%}
