...
! Expected string vector of length 1
 ...
 ```{r}
 #| eval: FALSE
cytoset <- load_cytoset_from_fcs(fcs_files, truncate_max_range = FALSE,
 transformation = FALSE)
cytoset
 ```
...
plot(gs)
```
![](C:/Users/Macarena/MacarenaLM/notes/week04/04_IntroToTidyverse/week 05 Gating sets notes/imagenweek5.png){width=50%}
...
```{r}
#| eval: FALSE
AlternateGS <- flowjo_to_gatingset(ws=ws, name=1, path = Folder, additional.keys="GROUPNAME",
...
```
![](C:/Users/Macarena/MacarenaLM/notes/week04/04_IntroToTidyverse/week 05 Gating sets notes/plot.png){width=40%}
...
```
![](C:/Users/Macarena/MacarenaLM/notes/week04/04_IntroToTidyverse/week 05 Gating sets notes/plot2.png){width=40%}
For CD8+
```{r}
#| eval: FALSE
ggcyto(gs[1], subset="CD8+", aes(x="IFNg", y="TNFa")) + geom_hex(bins=100) 
```
![](C:/Users/Macarena/MacarenaLM/notes/week04/04_IntroToTidyverse/week 05 Gating sets notes/plot3.png){width=40%}
...
```
![](C:/Users/Macarena/MacarenaLM/notes/week04/04_IntroToTidyverse/week 05 Gating sets notes/plot4.png){width=40%}

```{r}
#| eval: FALSE
ggcyto(gs[6], subset="Tcells", aes(x="CD4", y="CD8")) + geom_hex(bins=100)
```
![](C:/Users/Macarena/MacarenaLM/notes/week04/04_IntroToTidyverse/week 05 Gating sets notes/plot5.png){width=40%}
